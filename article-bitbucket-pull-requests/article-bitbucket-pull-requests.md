This article is taken almost directly from [Atlassian's Working with pull requests](https://confluence.atlassian.com/bitbucket/work-with-pull-requests-223220593.html). Some modifications were made to the layout.
